...
def generate_dockerfile(client, model, application, misconfigurations):
    ...
    return generate_from_prompt(client, model, 'prompts/generate_dockerfile.md', user_prompt)
...
def generate_docker_compose(client, model, application, misconfigurations):
    ...
    return generate_from_prompt(client, model, 'prompts/generate_dockercompose.md', user_prompt)
